 ...
 * opened early 2025) is the timing accelerant, production capacity climbs materially
...
export const hEB: AccountMicrositeData = {
    ...
    { type: 'yns-thesis' },
    {
      ...
      composition: [
        ...
        },
        {
          ...
          value:
            '~500-acre distribution campus acquired near Hempstead TX (about an hour from Houston) for a multi-phase build starting late 2024, on top of an existing Houston DC plus a third Houston eCommerce fulfillment center (~100,000 sq ft) opened early 2025. The Hempstead campus is the cleanest greenfield embed for a yard operating-model layer in the network; the existing Houston DC is the highest-production capacity pressure point as the eCommerce-fulfillment ramp compounds against store-replenishment cadence. Houston is the active production capacity-add region, modernizing the buildings without modernizing the yard layer above the sites moves the flow-control wall from the warehouse to the gatehouse exactly as Houston production capacity climbs.',
        },
        {
    ...
    },
    {
      ...
      sources: [
        ...
        },
        {
          ...
          confidence: 'public',
          detail:
            '~500-acre site acquired near Hempstead TX (about an hour from Houston) for a multi-phase distribution campus; first phase of construction expected to start late 2024. Anchors the Houston-region production capacity-add window and the cleanest greenfield embed for a yard operating-model layer.',
  ...
  personVariants: [
    {
      ...
      stakeStatement:
        'Production capacity is climbing where the capex is landing first, Hempstead breaks ground on a multi-phase distribution campus across ~500 acres, the third Houston eCommerce fulfillment center opened in early 2025, and the existing Houston DC is absorbing the uplift in the meantime. At a regional DC running three inbound flow cadences against five banner-specific outbound cadences through one Parkway Transport fleet rhythm, an undecided dock door is not one appointment missed, it is a production-line, a detention line, a customs cutoff, and a banner-specific store-replenishment window all competing for the same five minutes of resolution. The operating-model layer above the regional DCs is the lever that scales with the production capacity uplift rather than gets squeezed by it; ratifying that layer into a network standard is a thing the H-E-B distribution leadership bench gets to author with the Hempstead-campus design still in flight, not after the campus is commissioned and the standard has to be retrofitted.',
      ...
      kpiLanguage: [
        ...
        'Houston production capacity ramp into the Hempstead campus window',
    ...
    },
    {
      ...
      stakeStatement:
        'Returns and reverse moves are the easiest part of the yard to under-instrument and the place where unrecovered private-fleet asset hours quietly accumulate. The Houston expansion and the eCommerce-fulfillment ramp add reverse complexity, not just forward production capacity.',
    ...
    },
    {
      ...
      stakeStatement:
        'The Houston production capacity ramp is the largest single-region production capacity-add event the H-E-B network has run in years. Designing the yard-operating-model layer at the Hempstead campus before commissioning is materially cheaper than retrofitting it after; the strategic seat is the one that can lock that timing.',

      heroOverride: {
        headline: 'The strategic-planning seat for the next-generation H-E-B yard operating model.',
        subheadline:
          'Three-flow dock arbitration at vertically-integrated regional DCs, Houston production capacity ramping into the Hempstead campus window, private-label SKU depth multiplying receiving-slot decisions. The operating-model layer above the regional DCs is the strategic wedge.',
      },
      sectionOrder: ['yns-thesis', 'observation', 'artifact', 'comparable', 'methodology', 'about'],
      ...
      kpiLanguage: [
        ...
        'Hempstead campus yard-operating-model design',
        'Houston production capacity ramp over 18–36 months',
        'private-label SKU depth versus receiving-slot density',
        'cross-border HEB Mexico inbound coordination',
        'operating-model layer above the regional DCs',
      ],
  ...
  network: {
    ...
    geographicSpread:
      'Texas-centered (HQ San Antonio TX) with northeastern Mexico via HEB Mexico (~70 stores). Cross-border freight flows through Laredo. Houston region is the active production capacity-add window.',
    dailyTrailerMoves:
  ...
  signals: {
    ...
    recentNews: [
      ...
      'New ~500-acre Hempstead TX distribution campus acquired; multi-phase construction starting late 2024. Cleanest greenfield embed for a yard operating-model layer in the Houston-region production capacity-add window.',
    ...
    supplyChainInitiatives: [
      ...
      'Houston region production capacity add, ~500-acre Hempstead TX distribution campus (multi-phase build starting late 2024), existing Houston DC absorbing the uplift in the meantime, third Houston eCommerce fulfillment center opened early 2025 (~100,000 sq ft), the largest single-region production capacity-add the network has run in years, on an 18–36 month window.',
    ],
    urgencyDriver:
      'The three-flow inbound arbitration problem at H-E-B regional DCs (own-manufacturing + CPG-partner + import) is structurally harder than the single-flow shape at mainstream-grocer peers, and vertical-integration depth makes the downstream cost of yard variance asymmetric, yard delay compounds across more of the value chain because more of the value chain is H-E-B. The Houston expansion (existing Houston DC + new ~500-acre Hempstead campus + third eCommerce fulfillment center opened early 2025) is the timing accelerant: production capacity is climbing materially over an 18–36 month window, and modernizing the buildings without modernizing the yard layer above the sites moves the production capacity constraint from the warehouse to the gatehouse.',
  },
