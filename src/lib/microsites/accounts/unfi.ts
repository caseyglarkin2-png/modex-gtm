 ...
 * materially different angle (consolidation production capacity math, not cold-chain
 * food-safety).
 *
 ...
 * Angle: YARD MANAGEMENT (consolidation production capacity math at surviving DCs;
 ...
 *        President + CSCO mandate), production capacity per dock, detention
  ...
  people: [
    {
      ...
      bestIntroPath:
        'Direct outreach to the dual-chair seat with consolidation-production capacity-math framing, explicitly different from the cold-chain food-safety angle of the March 2026 outreach that received no reply. Parallel-track outreach to Erin Horvath (CSCTO) is the second route, transformation chair is the operating-model-rebuild seat, separate enough from the operating P&L to read as parallel rather than escalation. UNFI HQ Providence RI is a plausible site-visit destination. If Bushway delegates: an Atlantic Region VP is the cleanest peer-network alternate given his Atlantic history.',
    },
  ],
