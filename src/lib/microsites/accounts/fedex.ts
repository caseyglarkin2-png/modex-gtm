 ...
 *
 * Pitch shape: INVERTED. FedEx is a carrier, not a shipper. The Tier-1 CPG anchor's
 * freight intensity (Primo Brands as public comparable for the larger bottled-water
 * network) is the kind of freight FedEx Freight COULD pick up — the question for
 * FedEx is whether their yard hand-offs at service centers leak the same minutes
 * Primo's pilot recovered on the shipper side. Yard execution is THE constraint
 * on the carrier's published transit-time promise.
 *
 * Active context (May 2026):
 *   - FedEx Freight spinoff separates June 1, 2026 (Form 10 filed Jan 2026,
 *     Investor Day Apr 8, 2026). Standalone NYSE listing as FDXF.
 ...
 *     centers); ~26,000 dock doors network-wide.
 *   - Tricolor air network rollout in parallel with Network 2.0.
 */
...
export const fedex: AccountMicrositeData = {
  ...
  pageTitle: 'FedEx · Yard execution as the constraint on the published transit-time promise',
  metaDescription:
    'FedEx Freight separates June 1, 2026 and Network 2.0 is rewriting ~30% of the NA facility footprint at the same time. The yard between the gate and the dock is where the published transit time becomes the realized one — and where carrier-side dwell pricing is decided on every shipper trailer.',

  sections: [
    { type: 'yns-thesis', headlineOverride: 'Yard execution as a service-promise constraint for the carrier' },
    {
      type: 'observation',
      headline: 'What we observed about the FedEx operating context',
      composition: [
        { label: 'FedEx Freight separation', value: 'Spin-off to standalone NYSE-listed entity (FDXF) on track for June 1, 2026 — Form 10 filed January 2026, Investor Day April 8, 2026. Parcel and LTL operating agreements separating in early spring 2026.' },
        { label: 'Network 2.0 status', value: '~360 facilities running Network 2.0-optimized today (~25% of eligible NA volume); 65% target by 2026 peak; 475+ station closures planned by end of 2027 — roughly 30% of the NA facility footprint.' },
        { label: 'FedEx Freight LTL footprint', value: '~323 terminals + ~13 relay locations (~360 service centers); ~26,000 dock doors network-wide; recent capacity adds in Phoenix (218 doors), Indianapolis-area (125 doors), Sioux Falls (76 doors).' },
        { label: 'CEO frame (Raj Subramaniam)', value: 'Three-part transformation: Network 2.0 ground-air integration, Tricolor air-network rebuild, FedEx Freight spin. Stated target: ~$2B Network 2.0 savings by end of 2027 and ~10% P&D cost reduction in rolled-out markets.' },
        { label: 'Yard-execution surface', value: 'Every Network 2.0 consolidated hub absorbs volume from multiple closed predecessor stations; service-center yards arbitrate parcel cross-dock and LTL trailer flow on overlapping infrastructure during the transition.' },
    ...
    },
    {
      ...
      sources: [
        {
          ...
          confidence: 'public',
          detail: 'Form 10 registration statement filed January 2026; inaugural FedEx Freight Investor Day held April 8, 2026; separation on track for June 1, 2026 with NYSE listing under FDXF. Parcel and LTL operating agreements separating in early spring 2026.',
        ...
        },
        {
          ...
          confidence: 'public',
          detail: '~360 facilities operating Network 2.0-optimized as of early 2026 (~25% of eligible NA average daily volume); 65% target by 2026 peak; 475+ station closures planned by end of 2027 (~30% of NA footprint). Stated savings target: ~$2B by end of 2027.',
        ...
        },
        {
          ...
          confidence: 'public',
          detail: 'Approximately 323 LTL terminals plus 13 relay locations (~360 service centers) as of mid-2025; ~26,000 dock doors network-wide. Recent terminal openings: Phoenix (218 doors), Greenwood IN (125 doors, Indianapolis area), Sioux Falls SD (76 doors).',
        },
        {
          id: 'fedex-investor-day-2026',
          source: 'FedEx Corporation 2026 Investor Day (Raj Subramaniam)',
          confidence: 'public',
          detail: 'Three-part transformation framing: Network 2.0 ground-air integration, Tricolor air-network strategy, FedEx Freight spin. AI deployment in hubs (e.g., Dexterity AI sortation) cited at +13% trailer utilization and >99% sortation accuracy. FY2029 adjusted free cash flow target ~$6B; capex falling toward ~4% of revenue.',
      ...
      unknowns: [
        'Which Network 2.0 consolidated hubs are currently absorbing the most exception flow from closed predecessor stations, and which of those are scheduled for optimization in the next ~115 facilities to be rolled in',
        'How the FedEx Freight spin governance is sequencing operating-standard decisions — whether yard-execution standardization belongs to the pre-spin parent timeline or to the post-spin FDXF management team',
  ...
  personVariants: [
    {
      ...
      framingNarrative:
        'Scott runs the contract-logistics and managed-transportation arm that sits at the seam between FedEx and the enterprise shippers whose freight crosses Ground hubs and Freight service centers every day. The carrier-side yard hand-off is the part of that seam where the published transit-time promise either holds or slips, and where the shipper\'s own yard-operating-model investments either continue across the dock or stop at the gate. Network 2.0 is consolidating ~30% of the NA facility footprint into ~360 optimized hubs; FedEx Freight separates June 1, 2026. Both rewrites land first on the yard.',
      openingHook:
        'The 237-facility CPG anchor — North America\'s largest bottled-water producer — pulled its average truck turn time from 48 minutes to 24 by running a network operating model above its site-level yard tooling. Those trailers cross FedEx Freight service centers and Network 2.0 hubs on the way to the consignee. The minutes that anchor recovered on the shipper side are the same minutes the carrier-side hand-off is currently absorbing.',
      stakeStatement:
        'Two structural rewrites are open simultaneously and they are not always open. Network 2.0 is rewriting the operating procedure at ~115 more facilities between now and 2026 peak; FedEx Freight\'s service-level math becomes a standalone NYSE filing on June 1, 2026. The yard-execution layer is cheaper to add during the rewrite than after it.',

      heroOverride: {
        headline: 'Yard execution as a service-promise constraint — for the carrier this time.',
        subheadline:
          'Network 2.0 closes 475+ stations by 2027 and routes that volume through ~360 consolidated hubs. FedEx Freight separates June 1, 2026 with ~26,000 dock doors across ~360 service centers. Both rewrites land on the same yard.',
      },
      sectionOrder: ['hero', 'problem', 'stakes', 'proof', 'solution', 'network-map', 'roi', 'testimonial', 'cta'],

      toneShift:
        'Peer-to-peer carrier-side framing. Acknowledge the existing yard-records tooling estate respectfully — site-level YMS where it exists is doing the records job. The wedge is the execution and orchestration layer above the records layer, sized for the Network 2.0 consolidation and the FedEx Freight separation. Anti-sales register; no booking CTA; no savings promise.',
      kpiLanguage: ['published-vs-realized transit time', 'service-center yard dwell', 'consolidated-hub queue depth', 'carrier scorecard', 'dock-door utilization', 'detention pricing power'],
      proofEmphasis:
        'Primo is the public comparable to cite — the operating model already proven on the hardest CPG freight. The directly-shaped 237-facility CPG anchor is the credibility flex if peer-reference becomes the topic. Both look like the freight FedEx Freight wants on its trailers.',
    },
    {
      person: {
        personaId: 'P-072',
  ...
  signals: {
    recentNews: [
      'FedEx Freight spin-off on track for June 1, 2026 — Form 10 filed January 2026; standalone NYSE listing under FDXF; inaugural Investor Day held April 8, 2026.',
      'Network 2.0: ~360 facilities running optimized today (~25% of eligible NA average daily volume); 65% target by 2026 peak; 475+ station closures planned by end of 2027 (~30% of NA footprint); ~$2B savings target.',
      ...
      'AI deployment in hubs (e.g., Dexterity AI sortation): cited at +13% trailer utilization, >99% sortation accuracy.',
    ],
    supplyChainInitiatives: [
      'Network 2.0 ground-air consolidation — 475+ station closures planned by end of 2027; routing volume through ~360 optimized hubs',
      'FedEx Freight separation (June 1, 2026) — standalone public LTL carrier; ~360 service centers and ~26,000 dock doors',
      'Tricolor air-network strategy — aligning aircraft capacity to service tiers in parallel with Network 2.0',
    ],
    urgencyDriver:
      'Two structural rewrites are open simultaneously and they are not always open. Network 2.0 is rewriting the operating procedure at ~115 more facilities between now and 2026 peak; FedEx Freight separates June 1, 2026 into a standalone NYSE-listed public company. The cheapest moment to add an execution-and-orchestration layer to the operating standard is during the rewrite, not after.',
  },
