...
export const georgiaPacific: AccountMicrositeData = {
    ...
    },
    {
      ...
      sources: [
        ...
        },
        {
          ...
          confidence: 'public',
          detail: '$83M project at the existing Palatka paper mill, including a 400,000 sq ft warehouse. Construction scheduled to begin February 2026. Material production capacity uplift on the consumer-products side; the warehouse build is a yard-layer redesign opportunity.',
  ...
  personVariants: [
    {
      ...
      stakeStatement:
        'Production capacity is climbing where the capex is landing first, Palatka in February 2026, the sustainable-packaging build that closed in 2025, the Anchor Packaging integration that closed in October 2025. Production capacity-out-the-door becomes trailer-into-the-yard. At a site running three customer-type cadences through one dock fleet, an undecided dock door is not one appointment missed, it is a retail-DC window, a contractor pickup, and a port cutoff competing for the same five minutes of resolution. The MBM Decision Rights line for that resolution is the lever that scales with the production capacity uplift rather than gets squeezed by it; ratifying that line into a network operating standard is a thing a permanent CEO authors on entry, not something an interim leader carries through a transition.',
      ...
      kpiLanguage: [
        ...
        'contractor walk-in production capacity',
    ...
    },
    {
      ...
      stakeStatement:
        'The Palatka FL warehouse build (Feb 2026 ground-breaking) and the sustainable-packaging capacity that closed in 2025 are both consumer-products production capacity uplifts. Production capacity-out-the-door becomes trailer-into-the-yard. At a dual-flow site, that pressure shows up at the doors first.',
    ...
    },
    {
      ...
      stakeStatement:
        'Capex is landing on the consumer-products side first (Palatka, the sustainable-packaging build, Anchor Packaging), which means production capacity on that side of the dual-flow is climbing while the wood-products outbound cadence has to find dock time against a faster appointment-window opposing flow. That is the moment the arbitration layer matters most.',
  ...
  signals: {
    ...
    urgencyDriver:
      'Production capacity is climbing where the recent capex is landing first, the Palatka expansion (Feb 2026 ground-breaking, 400,000 sq ft warehouse), the sustainable-packaging build that closed in 2025, the Anchor Packaging integration that closed in late 2025. At a dual-flow site, additional production capacity on the consumer-products side compresses dock time for the building-products outbound running against a different appointment regime. The yard-layer operating standard is the lever that scales with that production capacity uplift rather than gets squeezed by it.',
  },
