...
export const fritoLay: AccountMicrositeData = {
  ...
  people: [
    {
      ...
      strategicPriorities: ['Multi-site standardization', 'Production capacity optimization', 'Network execution visibility'],
      ...
      languagePreferences: ['network', 'standardization', 'execution', 'production capacity', 'at scale'],
  ...
  roiModel: {
    ...
    accountAssumptions: [
      ...
      },
      {
        ...
        value: 13_900,
        unit: 'moves/day',
        sourceNoteId: 'frito-production capacity-profile',
      },
      {
    ...
    sourceNotes: [
      ...
      {
        id: 'frito-production capacity-profile',
        label: 'Snack-network production capacity profile',
  ...
  signals: {
    ...
    recentNews: [
      ...
      'PepsiCo / Siemens / NVIDIA digital-twin collaboration (CES 2026), industry-first; physics-level twins of machines, conveyors, pallet routes, operator paths. 20% production capacity lift reported on initial deployment; 10–15% capex reduction through virtual validation.',
