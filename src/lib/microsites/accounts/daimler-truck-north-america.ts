...
export const daimlerTruckNorthAmerica: AccountMicrositeData = {
  ...
  personVariants: [
    {
      ...
      stakeStatement:
        'Tariff exposure on the Saltillo cross-border lane converts every minute of dwell-cycle variance into landed-cost amplification, variance reduction at the yard layer is now a margin lever, not just an operations one. Q1 2026 order intake came back +85% YoY into a network that just finished a soft quarter; the binding constraint in the next four quarters is production capacity per existing dock door, which means takt-per-dock and OEE-per-dock are the production capacity math, and no-capex software on top of what DTNA already operates is the only path that gets oxygen in 2026.',
  ...
  signals: {
    recentNews: [
      ...
      'Whitestown IN RDC (605,000 sq ft) opened August 2023, the aftermarket parts network was already reorganized for network production capacity three years ago; the same network logic applied to plant yards is the unfilled adjacency.',
