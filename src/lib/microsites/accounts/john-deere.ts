 ...
 * Quality Tier: B (Tier 3 Band D — heavy-equipment reach account)
 *
 ...
 * unveiled CES 2025 with full launch in 2026, 1M+ connected machines on
 * the John Deere Operations Center) and the manual yards between the
 * Waterloo / Davenport / Dubuque / East Moline assembly halls and the
 * dealer-delivery network. The yard between build and dealer delivery
 * is the unsolved seam beside the Smart Industrial strategy.
 *
...
export const johnDeere: AccountMicrositeData = {
  ...
  sections: [
    { type: 'yns-thesis' },
    {
      ...
      composition: [
        { label: 'U.S. manufacturing footprint', value: '~60 U.S. facilities; Moline IL global HQ; Quad Cities region density across Moline, East Moline, and Milan' },
        { label: 'Largest tractor complex globally', value: 'Waterloo IA Tractor Operations — 7R / 8R / 9R / 9RX assembly (including the 9RX830 at 830 HP); ~$500M invested over the last five years' },
        { label: 'Construction & forestry anchors', value: 'Davenport IA (articulated dump trucks, motor graders, 4WD loaders, skidders, attachments distribution); Dubuque IA (backhoes, crawler dozers, skid-steers, compact track loaders)' },
        { label: 'Combine + harvest line', value: 'East Moline IL — Harvester Works; the S- and X-series combine line; Quad Cities outbound flow runs alongside Moline HQ and Milan parts' },
        { label: 'Parts logistics anchor', value: 'Milan IL Parts Distribution Center — 2.8M sq ft, 800,000+ unique parts; ~80,000 picks per day / ~450,000 lines per week serving the global dealer network' },
        { label: 'Other U.S. specialty plants', value: 'Greeneville TN (compact utility tractors); Augusta GA (commercial mowing equipment); Coffeyville KS (commercial worksite products)' },
        { label: 'Dealer network', value: 'Independent dealer organizations across North America operating hundreds of branches — every finished machine has to land in one of those yards' },
        { label: 'In-field autonomy posture', value: 'Smart Industrial operating model (launched 2020); 1M+ connected machines; Operations Center covers 500M engaged acres; See & Spray ran across 5M acres in 2025 with ~50% herbicide reduction; autonomy retrofit kits unveiled at CES 2025 with broader 2026 availability' },
      ],
      hypothesis:
        'The interesting thing about John Deere\'s yard math is the same shape as the Caterpillar contradiction, but louder. Deere is now five years into the Smart Industrial operating model. The asset in the field is connected — over a million machines reporting in to the Deere Operations Center, See & Spray running AI on 5 million acres in 2025 and trimming herbicide use by roughly half, autonomy retrofit kits unveiled at CES 2025 with a broader 2026 rollout. The dealer-parts inventory build that has run for the last several years has put more SKUs through Milan IL than at any point in the company\'s history — 800,000+ unique parts, ~80,000 lines a day, ~450,000 lines a week, on a 2.8M sq ft floor. That is operating-system-grade thinking on the machine and on the parts catalog. The yard outside the machine and outside the warehouse has not moved at the same pace. Trailer staging at Milan, dock arbitration at Waterloo Works, yard sequencing for built-to-order 9RX tractors headed onto a flatbed, dealer-handoff staging across the Quad Cities corridor — those still run on radios, paper logs, and the tribal knowledge of the spotters who have been on site the longest. That gap matters in heavy equipment in a way it does not matter in CPG. A 9RX tractor is not a pallet — it is a multi-spot footprint on a flatbed or low-boy, with delivery customization (front weights, duals, GPS receivers, See & Spray heads if specced) often staged in the yard between the line and the dealer pickup. A combine is bigger. A 4WD articulated dump truck out of Davenport is bigger still. Fewer load events per day than a CPG plant, but each event blocks more dock real estate, longer setup and breakdown, and almost every machine is built to a specific dealer order on a specific customer commitment. That means yard sequence at Waterloo or Davenport *is* dealer-delivery sequence, and dealer-delivery sequence *is* the farmer\'s planting window or the contractor\'s jobsite start date. A reshuffle at the gate doesn\'t just delay a trailer; it slips a commitment two layers downstream. Parallel pressure is showing up on the other side of the network. The Milan parts DC, by virtue of the multi-year dealer-inventory build, has more outbound velocity than at any time in its history — and the dock-and-yard math at a 2.8M sq ft facility moving 80,000 lines a day is materially harder than at any single Cat or Kraft Heinz site we have looked at. The CPG playbook for network-level yard digitization translates here; the dock-arbitration logic has to be rebuilt for per-LOAD-hardest freight (Waterloo, Davenport, Dubuque, East Moline) and per-VELOCITY-hardest parts (Milan) running on the same operating model.',
      caveat:
    ...
    },
    {
      ...
      sources: [
        ...
        },
        {
          ...
          confidence: 'public',
          detail: 'Public unveil (Jan 2025) of the next-generation autonomy retrofit kits for tractors, tillage tools, and orchard sprayers. Limited dealer availability in 2025; broader rollout planned for 2026.',
        ...
        },
        {
          ...
          confidence: 'public',
          detail: 'See & Spray ran across 5M+ acres in 2025; ~50% herbicide reduction reported; 31M gallons of mix saved per public Deere reporting. Operating-system evidence on the asset, not on the yard.',
        },
        {
          id: 'deere-waterloo',
          source: 'John Deere Waterloo IA Tractor Operations',
          confidence: 'public',
          detail: 'Largest John Deere manufacturing complex globally; builds 7R / 8R / 9R / 9RX series including the 9RX830 (830 HP); ~$500M invested over five years. Public facility profile and Cedar Valley business reporting anchor the volume and capex.',
        },
        {
          id: 'deere-milan-parts',
          source: 'John Deere Milan IL Parts Distribution Center',
          confidence: 'public',
          detail: 'Public facility profile: 2,800,000 sq ft, 800,000+ unique part numbers, ~80,000 lines shipped daily / ~450,000 lines per week. Adjacent to Moline HQ and the Quad Cities assembly footprint; operating heart of Deere parts logistics.',
        },
        {
          id: 'industry-benchmarks',
          source: 'ATA + Aberdeen yard-operations benchmarks (industrial-freight cuts)',
          confidence: 'public',
          detail: 'Cross-industry baselines on dock-radio prevalence, dwell-time variance, and detention-cost ranges, with the heavy-haul / oversized-freight cuts where they exist. These describe the conditions most heavy-equipment networks operate under, not John Deere specifically.',
        },
        {
          id: 'primo-q1-2025',
    ...
    },
    {
      ...
      signOff:
        'If parts of this read wrong against what you see internally — particularly the share of yard work that already runs on site-level YMS at Milan, the share that still runs on radios at the assembly plants, and where the Smart Industrial digital stack has (or has not) crossed into yard operations — that\'s the most useful thing to push back on. The next step that makes sense is whatever the analysis prompts, not necessarily a meeting.',
    },
  ],
  ...
  personVariants: [
    {
      ...
      framingNarrative:
        'Cory, the Lifecycle Solutions, Supply Management, and Customer Success remit sits exactly where the contradiction shows up first. Smart Industrial has put 1M+ connected machines into the Operations Center; See & Spray ran AI on 5M acres in 2025; the autonomy retrofit kits unveiled at CES 2025 land more broadly in 2026. At the same time, the parts velocity out of Milan IL has never been higher — 800,000+ SKUs, ~80,000 lines a day — and the finished-machine yards at Waterloo, Davenport, Dubuque, and East Moline still run on radios. Lifecycle Solutions is the seam where the in-field digital asset and the dealer-delivery commitment meet; the yard is the layer between them that has not moved at the same pace.',
      openingHook:
        'The asset in the field got smart. The yard between the factory and the dealer did not. From the Lifecycle Solutions seat, that gap is the customer-success gap before it is anything else.',
      stakeStatement:
        'Every built-to-order machine and every 80,000-line parts day is a dealer commitment downstream of the yard. When yard sequence at Waterloo or Milan slips, dealer-delivery slips, and the planting window or jobsite start date the dealer committed to slips with it. Per-load freight economics mean fewer events per day than CPG — but each event blocks more dock and stages more customization, and the recovery margin on a missed planting-window commitment is thinner than anywhere in CPG.',

      heroOverride: {
        headline: 'Cory, the Operations Center sees the machine. It does not see the yard the machine left.',
        subheadline:
          '1M+ connected machines. 5M acres of See & Spray. CES 2025 autonomy retrofit kits broadening in 2026. And the yards at Waterloo, Davenport, Dubuque, East Moline, and Milan still run on radios. Lifecycle Solutions is the seam where that gap is most visible.',
      },
      sectionOrder: ['yns-thesis', 'observation', 'comparable', 'methodology', 'about'],

      toneShift:
        'Operator-to-operator. Cory has the cross-functional Lifecycle / Supply / Customer Success view that touches both the in-field digital asset and the dealer-delivery promise. Don\'t pitch yard tech — diagnose the contradiction between an industry-leading connected-machine operating system and a yard layer that hasn\'t moved with it.',
      kpiLanguage: [
