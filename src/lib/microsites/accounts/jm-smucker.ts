...
export const jmSmucker: AccountMicrositeData = {
    ...
    },
    {
      ...
      sources: [
        ...
        },
        {
          ...
          confidence: 'public',
          detail: 'New building, renovation, and equipment; at least 48 new jobs. Production capacity-out-the-door from the expansion becomes trailer-into-the-yard at the same site over the same window.',
        ...
        },
        {
          ...
          confidence: 'public',
          detail: 'Sherman TX and Kansas City MO coffee plants closed; Folgers and Café Bustelo volume consolidated to New Orleans. The single-site concentration of coffee production capacity is the most operationally calibrated baseline in the U.S. network.',
        },
        {
  ...
  personVariants: [
    {
      ...
      openingHook:
        'The CPSO mandate the restructuring built around your seat puts the Hostess integration, the $100M synergy clock, and the Columbus expansion under the same single ownership for the first time. The yard layer is where those three threads converge, and the trailer-turn cadence at the sites that share two freight grammars is the layer that converts public synergy commitments into observable production capacity.',
      stakeStatement:
        'Production capacity-out-the-door from the $120M Columbus, GA expansion becomes trailer-into-the-yard at the same site over the same window run-rate on the $100M synergy is expected. Legacy Smucker yard logic and inherited Hostess yard logic were not designed to agree with each other, and the integration window is the moment that either gets authored at the parent operating-model layer, by the seat the org was just restructured to create, or keeps getting decided plant-by-plant by whoever is on the radio that shift. The synergy clock is the timing driver; the CPSO mandate is the ownership.',
      ...
      kpiLanguage: [
        ...
        'carrier scorecard',
        'network production capacity variance',
      ],
      proofEmphasis:
    ...
    },
    {
      ...
      stakeStatement:
        'Sweet baked goods on a shorter clock, ambient on a longer one, both wanting the same door, the production capacity leak is the difference between scheduled and actual, every shift, every site that handles both profiles.',

      heroOverride: {
        headline: 'The WMS stops at the dock door. The yard is what\'s on the other side.',
        subheadline:
          'After Hostess, multiple freight profiles share dock infrastructure that wasn\'t designed for the combination. The production capacity leak lives between the gate and the door.',
      },
      sectionOrder: ['yns-thesis', 'observation', 'artifact', 'comparable', 'methodology', 'about'],
      ...
      kpiLanguage: ['truck turn time', 'detention cost', 'dock-door utilization', 'production capacity per shift', 'operational variance'],
      proofEmphasis: 'The headcount-neutral customer quote resonates strongest at the warehousing-ops level, same building, same staffing, more production capacity.',
    },
  ],
  ...
  signals: {
    ...
    urgencyDriver:
      'The Chief Product Supply Officer role is two months old; the COO role was eliminated to put enterprise execution under a single seat. The Hostess integration is two years in and the public $100M synergy target needs to convert into observable production capacity. Columbus GA production capacity from the $120M expansion lands through early 2027, that production capacity becomes trailer-into-the-yard at the same site over the same window.',
  },
