...
export const kraftHeinz: AccountMicrositeData = {
  ...
  sections: [
    { type: 'yns-thesis' },
    {
      ...
      composition: [
        { label: 'U.S. manufacturing footprint', value: '~30 U.S. plants across ambient / refrigerated / frozen, ~70 globally, the operating-system surface Agile@Scale and Lighthouse already touch, and the network yard layer beneath them does not' },
        ...
        { label: 'Active modernization', value: '$3B U.S. plant investment announced May 2025, production capacity-out-the-door capacity climbing across ~30 sites' },
        { label: 'Existing yard-tech layer', value: 'Legacy site-level yard automation from a 2007–2009 rollout; current production status across the surviving sites is mixed. The network-level operating layer that would feed Lighthouse is unsolved either way' },
    ...
    },
    {
      ...
      sources: [
        ...
        },
        {
          ...
          confidence: 'public',
          detail: 'Largest plant investment in decades, touching ~30 U.S. facilities. Operationally, this is a plant-level capacity, automation, and reliability program, the kind that creates production capacity downstream of the yard.',
  ...
  network: {
    ...
    dailyTrailerMoves: 'High-volume, modeled at the network level across ~30 U.S. plants and rising as $3B modernization production capacity lands',
  },
  ...
  marginaliaItems: [
    ...
    { mark: 'Greenfield', body: 'DeKalb · $400M · opens 2027 · highest-production capacity single node.' },
  ...
  audioBrief: {
    ...
    generatedAt: '2026-05-14T00:34:00Z',
  },
