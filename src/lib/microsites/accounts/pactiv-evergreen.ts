...
export const pactivEvergreen: AccountMicrositeData = {
  ...
  sections: [
    ...
    },
    {
      ...
      authorBio:
        'Casey Larkin builds YardFlow at FreightRoll. The brief above is a working analysis, not a sales asset — it is the same shape of memo we would circulate internally before sizing a combined-network engagement. Pactiv Evergreen / Novolex is distinctive in this round because the case for site-level yard automation at the Pactiv-legacy sites is not in dispute — it was won in 2019 and the case study is public, the operating sponsor is a 30-year company insider now named CTO of the combined entity. The unsolved problem is the combined-network operating layer above two parallel yard stacks, on a synergy-capture cadence Apollo and CPP have a fiduciary obligation to deliver against. The water comparable is intentional: Primo Brands runs the operationally hardest CPG freight in the country, and the network-orchestration read-across to a multi-channel, multi-customer, hub-and-spoke packaging network with foodservice-JIT service-level pressure is the easier lift.',
      authorEmail: 'casey@freightroll.com',
      signOff:
        'If parts of this read wrong against what you see internally for Pactiv Evergreen / Novolex — particularly which Novolex-legacy sites run what yard stack, where the post-combination volume re-concentration is biting hardest at surviving sites, or how McDonald\'s and Starbucks JIT service-level reliability is being measured at the gate-to-dock layer today — that\'s the most useful thing to push back on. The next step that makes sense is whatever the analysis prompts, not necessarily a meeting.',
    },
  ],
  ...
  personVariants: [
    {
      ...
      framingNarrative:
        'Chuck, the PMO/IMO discipline you carried into the Business Transformation seat — and the Army War College thinking about structured execution under uncertainty — is exactly the discipline that turns two parallel yard stacks into one combined-network operating layer. The site-level case was closed at the 12 Pactiv yards in 2019; the work is real and the case study is public. The unsolved layer is the network-tier orchestration view across ~95 combined yards, and the Apollo + CPP synergy-capture mandate is the dialect that recognizes it.',
      openingHook:
        'The site-level yard tools at the Pactiv-legacy sites were the right answer to the 2019 yard-visibility problem. The combined Novolex+Pactiv network is a different shape — ~95 yards across two parallel operating models, 39,000 SKUs, hub-and-spoke mixing centers like Temple TX serving downstream nodes that did not exist on the same playbook a year ago. The next move is not more instances of the existing stack at acquired Novolex sites — it is a network-tier orchestration layer that ingests from both sides and presents a single combined-network view to the integration team.',
      stakeStatement:
        'Apollo and CPP Investments underwrote $6.7B on combined-network synergy capture. Running two parallel yard stacks indefinitely is the opposite of synergy. The cleanest moment to land a combined-network operating layer at integration speed is the April 2025–April 2027 window — month 13 of 24 as of May 2026, with site rationalization (Kalamazoo April–June 2025, Pactiv Footprint Optimization) continuing to compress trailers through surviving yards on the same dock count. The McDonald\'s and Starbucks service-level surface is downstream of every gate-to-dock decision.',
