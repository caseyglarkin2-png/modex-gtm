  ...
  sections: [
    ...
    },
    {
      ...
      unknowns: [
        ...
        'Whether McPherson\'s first-year operating-priority list has the yard-layer operating standard inside it as its own line item, or whether it sits underneath broader Cheney-integration or Southeast-production capacity buckets, and which seat (President & COO successor, EVP Supply Chain, Chief Operating Officer of Performance Foodservice) is the operational owner once the standard is authored',
  ...
  personVariants: [
    {
      ...
      proofEmphasis:
        "Primo is the public comparable to cite, same operating-model shape (multi-site, multi-temp, drop-trailer, customer-delivery-cadence gated), harder freight per trailer, fewer SKUs and channels to coordinate. The proof shape that maps cleanest to the Cheney-integration absorption problem is the headcount-neutral-while-absorbing-more-volume quote, exactly the posture PFG needs as the Southeast build-out lands new production capacity at the integrating sites. The directly-shaped comparable (the un-name-able 237-facility CPG anchor) is the credibility flex if peer reference becomes the topic.",
