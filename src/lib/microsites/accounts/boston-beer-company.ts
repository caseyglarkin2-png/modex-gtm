  ...
  sections: [
    { type: 'yns-thesis' },
    {
      ...
      composition: [
        ...
        { label: 'Internal-production shift (the volume math)', value: '85% → 95% internal in Q1 2026, on ~1.6M barrels of shipment volume — roughly 160,000 barrels of volume shifted from City Brewing contract sites into the PA, Cincinnati, and Milton DE yards in a single quarter. FY2026 guidance: internal production above 90% for the full year (vs. 86% last year) — the shift is structural, not a one-quarter spike. Same dock count, same site-level yard system, materially more trailers under it' },
        { label: 'Q1 2026 scoreboard (the CSCO\'s first quarter)', value: 'Gross margin 49.3% · +100 bps YoY · attributed publicly to procurement savings + brewery efficiencies. Revenue −4.4% on volume −6.9%; depletions −4%. The margin line is the lever Savastano is being measured on — it is the only growth line on the scoreboard, and it is operating-efficiency-driven, not price-driven. Brewery efficiency without yard efficiency hits the same dock-cycle wall every plant operator already knows' },
        { label: 'SKU mix shift (peak-Truly → 2026, Twisted/Truly volume math)', value: 'Yard SOPs from 2020–2021 were designed for high-velocity 12-pack canned hard seltzer at peak-Truly cadence. The 2026 mix is Twisted Tea (durable cash-flow franchise growing ~4% in Q1, replaced Truly as the depletions anchor), Truly (still in the mix but declining off peak), Sun Cruiser (top-5 spirits RTD growth brand, different TTB classification, no new doors needed), Hard MTN Dew (running through traditional beer wholesalers since February 2024), and the craft tail (Sam Adams, Angry Orchard, Dogfish Head) on glass + aluminum. The Twisted-up / Truly-down swap inside roughly the same total barrel count means the same docks now handle a different brand sequencing and wholesaler combination — ~2–3× SKU/wholesaler combination complexity at the same dock count' },
    ...
    {
      type: 'artifact',
      headline: 'A coverage map for the brewery network',
      artifact: {
        imageSrc: '/artifacts/boston-beer-company-coverage-map.svg',
        imageAlt: 'Brewery network coverage map. Six tiles representing Boston Beer brewery sites and contract footprint. PA Brewery (Breinigsville, largest plant), Cincinnati OH (4× canning, packaging anchor), Milton DE (Dogfish Head, acquired 2019), Jamaica Plain MA (heritage and taproom), and Contract Brewing (City Brewing across WI / TN / PA / CA) all run site-level operations and are marked covered. The Yard Network Ops tile representing the dock-cycle measurement layer above gate-and-locate is unfilled, marked with a Boston Beer red hairline outline.',
        caption: 'Brewery network coverage map · 5 sites covered · 1 tile unfilled.',
        source: 'Composition modeled from public Boston Beer brewery disclosures. Site-level yard vendors redacted.',
      },
    },
    {
      type: 'comparable',
    ...
    },
    {
      ...
      sources: [
        ...
        {
          id: 'savastano-tenure',
          source: 'Phil Savastano — public tenure record',
          confidence: 'public',
          detail: 'Joined Boston Beer March 2024 to lead operations at the Samuel Adams Pennsylvania Brewery (Breinigsville/Fogelsville, PA — the largest plant in the network); promoted to Chief Supply Chain Officer effective October 20, 2025 after approximately 18 months on the floor. CSCO remit: brewery management, procurement, customer service, engineering, safety, quality, planning. Career arc pre-Boston Beer: Tesla (AGV/MES operating discipline) → Molson Coors (brewery operations) → Sam Adams PA. Q1 2026 +100 bps gross margin attributed publicly to procurement savings + brewery efficiencies is the first quarterly result under his tenure.',
          url: 'https://www.bostonbeer.com/news/2025/10/boston-beer-company-names-phil-hodges-chief-operating-officer',
        },
      ],
      unknowns: [
        ...
        'Where the ~160,000-barrel internal-production shift in Q1 2026 is biting hardest — and which yards are running closest to dock-cycle capacity right now',
        ...
        'Whether the operating discipline Savastano carried from Tesla\'s AGV/MES baseline and Molson Coors brewery operations into the PA brewery floor has been codified into reusable SOPs — and whether the next 30–50 bps of brewery-efficiency margin in FY2026 has a named yard-execution line item against it',
        'How the Twisted-up / Truly-down brand-mix swap is changing the brewery-to-wholesaler trailer sequencing at PA and Cincinnati — and whether the dock priorities encoded in the existing system still match the 2026 mix or are still tuned for the 2020–2021 peak-Truly cadence',
      ],
    },
    {
      type: 'about',
      ...
      signOff:
        'Phil — the eighteen months you spent on the floor at the Sam Adams PA brewery before the CSCO seat are the unusual qualification that makes this conversation worth your time. You ran that yard personally; you know which docks idle, which trailers stack, and which wholesaler windows the existing site-level system was never asked to arbitrate. The part most worth pushing back on is whether the in-yard execution layer above the gate-and-locate stack at PA — the layer the next 30–50 bps of brewery-efficiency margin lives in — is already on someone\'s Q2/Q3 list under a different name, or whether the +100 bps you booked in Q1 needs that layer to compound through the rest of FY2026 as 95% internal production continues. That answer reshapes the rest of this. The next step that makes sense is whatever the analysis prompts — a site visit at PA, a 30-minute working call against the Q1 scoreboard, or nothing at all — not necessarily a meeting.',
    },
  ],
  ...
  personVariants: [
    {
      ...
      framingNarrative:
        'Phil, the eighteen months you spent on the floor at the Sam Adams PA brewery before the CSCO seat are the unusual qualification this conversation needs in seat. Tesla taught you what event-driven measurement and AGV/MES discipline look like when they are the operating default; Molson Coors taught you how a brewery floor actually metabolizes that discipline; PA is where you ran it personally, against the existing gate-and-locate yard system, with the dock-cycle wall already visible. The +100 bps you delivered in Q1 2026 is the first quarter of your tenure — and the in-yard execution layer above the site-level system is the lever that compounds that win as 95% internal production continues through FY2026 against the same dock infrastructure you already know by heart.',
      openingHook:
        'You spent eighteen months on the floor at the PA brewery before the CSCO seat — that is the yard you know personally, dock by dock, shift by shift. The site-level gate-and-locate system at PA gives you the trailer-position records layer. What it does not give you, and what Q1\'s +100 bps brewery-efficiency number now requires from the CSCO scorecard, is the in-yard execution and dock-cycle measurement layer above it — the layer that determines whether the ~160,000 barrels of internal-production shift in Q1 alone lands inside the dock-cycle envelope at PA, Cincinnati, and Milton DE, or breaks it on the same dock count you ran for 18 months.',
      stakeStatement:
        '85% → 95% internal in one quarter, with FY2026 guidance above 90% for the full year. That is structural — not a one-quarter spike — and it lands on the same PA, Cincinnati, and Milton DE dock infrastructure you operated through the Twisted-up / Truly-down brand swap, with Hard MTN Dew now pulling traditional beer-wholesaler windows since February 2024 and Sun Cruiser adding a top-5 spirits-RTD lane through the same doors. Brewery efficiency without yard efficiency hits the same dock-cycle wall every PA-brewery operator already knows. The next 30–50 bps of margin lives in the in-yard execution layer above the gate-and-locate system you ran for 18 months — and Q2, Q3, Q4 of FY2026 are the quarters the scoreboard will read it on.',

      heroOverride: {
        headline: 'Q1 2026 brewery efficiency was the first pull. Dock-cycle measurement above gate-and-locate is the next one.',
        subheadline:
          '95% internal production lands roughly 160,000 more barrels through PA, Cincinnati, and Milton DE — against the same dock infrastructure those yards had at peak Truly, and the FY2026 guidance above 90% says it continues. The gate-and-locate layer Boston Beer already operates answers "where is trailer X?" — not "why did dock 3 sit idle for 18 minutes, and what should have happened?" That\'s the layer above, and the PA brewery you ran for 18 months is the cleanest place to prove it.',
      },
