 ...
 * Quality Tier: Tier 3 / Band D — automotive, JIT-native manufacturer
 * Pitch shape: JIT-assembly wedge framed against the EV-Hub-to-flex-line
 * reversal. Honda spent ~$1B retooling Marysville Auto Plant, East Liberty
 * Auto Plant, and Anna Engine Plant for the Ohio EV Hub through 2024-2025,
 * then in March 2026 cancelled the all-EV roadmap (¥2.5 trillion / ~$15.7B
 * in losses) and pivoted Marysville and East Liberty back to flex-line
 * production of ICE, hybrid, and BEV variants on the same lines. The LG
 * Energy Solution joint-venture battery plant in Jeffersonville OH
 * (~$3.5B build, ownership consolidated to Honda via Feb 2026 sale and
 * leaseback at W4.2 trillion / ~$2.9B) began battery production on
 * schedule in late 2025 to feed IPU sub-assembly at Marysville. The
 * yard problem isn't a clean greenfield design exercise anymore — it's
 * a multi-plant Ohio campus running mixed-variant flex production with
 * cell inbound from Jeffersonville while the rest of the strategy is
 * still reshuffling.
 *
 * Public anchors:
...
export const honda: AccountMicrositeData = {
  ...
  sections: [
      ...
      composition: [
        {
          ...
          value: 'Marysville Auto Plant (Marysville OH — flagship, now flex-line ICE/hybrid/BEV after the March 2026 reversal; first BEV based on the Acura Performance EV Concept was scheduled here for late 2025), East Liberty Auto Plant (East Liberty OH — flex-line, scheduled to assemble Sony Honda Mobility AFEELA 1 starting fall 2025), Anna Engine Plant (Anna OH — retooled inside the Ohio EV Hub envelope), Honda Manufacturing of Alabama (Lincoln AL — Odyssey, Pilot, Passport, Ridgeline, V6 engines), Honda Manufacturing of Indiana (Greensburg IN — Civic, CR-V Hybrid)',
        },
        {
          label: 'Ohio EV Hub investment status',
          value: '~$1B retooling at Marysville, East Liberty, and Anna through 2024-2025 to set up flexible production capable of building ICE, hybrid, and BEV on the same lines. ~300 associates at Marysville upskilled for IPU (battery module + controlling hardware/software) sub-assembly to feed the assembly side at both Marysville and East Liberty',
        },
        {
          label: 'Battery-cell node',
          value: 'L-H Battery Company (LG Energy Solution + Honda JV) in Jeffersonville OH — ~$3.5B build, 2,200 jobs, pouch-type lithium-ion. Mass production scheduled to begin late 2025; building ownership consolidated to Honda for ~$2.9B in February 2026 with LG continuing to operate under a lease. Cells feed the Marysville IPU sub-assembly that supplies both Ohio assembly plants',
        },
        {
          label: 'March 2026 strategic reversal',
          value: 'Honda cancelled its all-EV roadmap and the 0 Series production rollout in March 2026 (~¥2.5 trillion / ~$15.7B in losses), pivoting Marysville and East Liberty back to ICE-and-hybrid as the volume product. Sony Honda Mobility cancelled AFEELA 1 production on March 25, 2026, with the East Liberty trial-build line redirected. The flex-line architecture remains; the variant mix the flex line now arbitrates against is different than the one it was retooled for',
        },
        {
    ...
    },
    {
      ...
      sources: [
        ...
        },
        {
          ...
          confidence: 'public',
          detail: '~$1B retooling investment across Marysville Auto Plant, East Liberty Auto Plant, and Anna Engine Plant through 2024-2025 to enable flexible production of ICE, hybrid, and BEV on the same lines. ~300 associates at Marysville upskilled for IPU sub-assembly to feed both Ohio assembly plants.',
      ...
      unknowns: [
        ...
        'How the L-H Battery cell inbound from Jeffersonville OH into the Marysville IPU sub-assembly is being staged today (segregated lanes, dedicated dock, or co-mingled with conventional parts inbound)',
        'How the AFEELA-1 production cancellation is reshaping the East Liberty trial-build operating pattern through the rest of 2026 — and whether the redirected line has hardened into a new variant cadence yet',
        'Where the Marysville Regional Logistics Centre handoff into the assembly-plant receiving yards lives in current operating practice — what is owned by the RLC versus the plant gate',
    ...
    },
    {
      ...
      authorBio:
        "Casey Larkin builds YardFlow at FreightRoll. The brief above is a working analysis, not a sales asset — it is the same shape of memo we would circulate internally before sizing a network engagement. Honda is distinctive in this round because the analytical wedge sits in a narrow operating window: the Ohio EV Hub retool is complete, the L-H Battery cell inbound from Jeffersonville is live, the March 2026 all-EV reversal redirected the flex lines back to ICE-and-hybrid volume, and the AFEELA-1 cancellation reshaped the East Liberty trial-build cadence. The flex-line architecture and the JIT discipline that runs the inside of the plant are intact through all of that. The yard layer between the 700-supplier inbound network and the assembly dock is the operating layer the reversal didn't touch — and the period where the post-reversal pattern is still settling is when standardizing that layer costs least.",
      authorEmail: 'casey@freightroll.com',
      signOff:
        "If parts of this read wrong against what you see internally for Honda — particularly whether the flex-line variant mix is already showing up as dock arbitration cost, how the Jeffersonville cell inbound is being staged at Marysville today, where the AFEELA-1 redirect leaves the East Liberty operating pattern, or how the RLC-to-receiving-yard handoff actually works — that's the most useful thing to push back on. The next step that makes sense is whatever the analysis prompts, not necessarily a meeting.",
    },
  ],
  ...
  personVariants: [
    {
      ...
      framingNarrative:
        "Jim, the Honda JIT discipline runs deep at the plant level — andon-cord authority, line-side rack discipline, kaizen-iterated standardized work. The piece this analysis pokes at is the one layer that discipline hasn't yet covered: the yard between the supplier truck arriving at the gate and the trailer being live at the right dock. The Ohio EV Hub retool is complete, the L-H Battery cell inbound from Jeffersonville is live, and the March 2026 reversal pivoted Marysville and East Liberty back to flex-line ICE-and-hybrid volume on the same lines. The flex-line architecture has to arbitrate a wider variant mix than it was designed against; the yard layer above the dock is where that variance budget gets paid for first.",
      openingHook:
        "JIT works inside the plant because the part is there when the line pulls for it. The same kanban-pull logic cannot pull a part that hasn't reached the dock. Every minute of yard variance between the supplier truck and the assembly dock is, by definition, a JIT violation — the line was ready and the part wasn't. The line-side discipline that took decades to build inside Honda's plants is the same shape of discipline the yard layer above the dock has not yet been standardized to.",
      stakeStatement:
        "The post-March-2026 flex-line variant mix at Marysville and East Liberty is broader than the lines were retooled for. The L-H Battery cell inbound from Jeffersonville is a single-source, weight-heavy, hazmat-classified lane that didn't exist in the operating model two years ago and is now load-bearing for the BEV slice of every flex line it feeds. The variance budget per supplier shrinks as the supplier mix widens — and every minute the yard layer doesn't standardize is a minute that has to be absorbed somewhere else in the JIT chain.",

      heroOverride: {
        headline: "Jim, the yard between Honda's 700 inbound suppliers and the assembly dock is the one layer the March 2026 reversal didn't touch.",
        subheadline:
          "The Ohio EV Hub retool is complete. The L-H Battery JV in Jeffersonville is live. Marysville and East Liberty are running flex-line ICE, hybrid, and BEV on the same lines. The yard layer above the receiving plants is still on plant-by-plant local routine — and the period when the post-reversal pattern is still settling is when standardizing it costs least.",
      },
      sectionOrder: ['yns-thesis', 'observation', 'comparable', 'methodology', 'about'],

      toneShift: "Operator-to-operator. Jim lives in the operational seam between Honda Trading Group lane planning, the Marysville RLC, and the receiving yards. Position the wedge as an extension of the Honda JIT discipline, not as replacement of any installed plant-level practice. Acknowledge the JIT-at-scale inheritance as the inheritance it is.",
      kpiLanguage: [
