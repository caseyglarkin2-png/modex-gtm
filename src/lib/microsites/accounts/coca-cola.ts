...
export const cocaCola: AccountMicrositeData = {
  ...
  sections: [
    { type: 'yns-thesis' },
    {
      ...
      composition: [
        ...
        { label: 'Peak pattern', value: 'Summer surge (Memorial Day → Labor Day) drives ~40% volume spike; yards designed for average production capacity compress hardest in that window. Holiday and Super Bowl windows add secondary peaks.' },
    ...
    },
    {
      ...
      sources: [
        ...
        },
        {
          ...
          confidence: 'public',
          detail: '620,000-sq.-ft. bottling facility breaking ground 2026 in southeast Colorado Springs. Adds production capacity in Swire\'s 13-state western footprint and creates a greenfield yard-design entry point with no entrenched operating practice to displace.',
  ...
  people: [
    ...
    },
    {
      ...
      strategicPriorities: ['Bottling execution discipline', 'End-to-end supply synchronization', 'Peak-season production capacity', 'Repeatable operating standards across BIG facilities'],
      knownPainPoints: [
      ...
      languagePreferences: ['bottling', 'end-to-end', 'production capacity', 'execution', 'supply synchronization'],
      connectionHooks: [
    ...
    },
    {
      ...
      knownPainPoints: [
        ...
        'Peak-season production capacity pressure compounds into both cost and service misses',
  ...
  personVariants: [
    ...
    },
    {
      ...
      heroOverride: {
        ...
        subheadline:
          'BIG operates bottling end-to-end across multiple markets. The yard layer above the sites is where dock arbitration, multi-temp staging, and peak-season production capacity either hold together or do not, and where one execution standard pays back fastest.',
      },
      sectionOrder: ['yns-thesis', 'observation', 'comparable', 'methodology', 'about'],

      toneShift:
        'Operator-to-operator. Jadhav lives in bottling execution across multi-market environments, concentrate flow, dock sequencing, peak-season production capacity. He does not need the franchise governance argument explained; he needs the operating-layer case. Speak to the physical reality of the dock and the gate.',
      kpiLanguage: [
        'production capacity',
        'dock turns',
        'bottling execution',
