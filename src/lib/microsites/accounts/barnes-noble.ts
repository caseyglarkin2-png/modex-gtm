  ...
  sections: [
    ...
    },
    {
      ...
      unknowns: [
        ...
        'Whether the 60-stores-a-year expansion is being absorbed inside the existing 115-dock-door count or whether the production capacity math has already created pressure to add dock capacity',
  ...
  personVariants: [
    {
      ...
      stakeStatement:
        'Sixty new stores a year on a flat dock-door count, with the ICv2-reported IPO trajectory on the calendar behind it, is a quiet production capacity problem. The store-tier reset is delivering measurable financial results; the dock-tier operating model that supports it is still doing the channel-arbitration math one shift at a time, on tooling built for the prior cadence. The store tier and the dock tier no longer match each other, and the dock tier is the only operating-system surface at B&N that has not yet been reshaped to the post-Daunt demand pattern.',
