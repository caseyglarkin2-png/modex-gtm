 ...
 * trailer-into-yard pressure from T&M production capacity lift (Tucker GA bacon-line
  ...
  sections: [
    { type: 'yns-thesis' },
    {
      ...
      composition: [
        ...
        },
        {
          ...
          value: 'Tucker GA bacon line shut Oct 2025 (135 separations), production reallocated under T&M footprint optimization. Planters Suffolk VA facility temporarily disrupted; co-packer partnerships used to protect fill rates. T&M production capacity lift is showing up at the dock door before it shows up on the income statement',
        },
        {
    ...
    },
    {
      ...
      unknowns: [
        ...
        'Where T&M plant-modernization production capacity lift has already started producing visible trailer congestion at the gatehouse, particularly the Tucker GA reallocation pattern across receiving protein plants',
  ...
  personVariants: [
    ...
    },
    {
      ...
      heroOverride: {
        ...
        subheadline:
          "o9 plans the network. The yard executes it. The seam between the two is where multi-temp arbitration, Planters-network SOPs, and T&M production capacity pressure all land, and where a planning COE can see the lift before anyone else does.",
      },
      sectionOrder: ['yns-thesis', 'observation', 'artifact', 'comparable', 'methodology', 'about'],
    ...
    },
    {
      ...
      framingNarrative:
        "Connor, the Hormel Production System has set the work standard inside the plant, that's where most of the operating discipline sits, and it shows. The piece this analysis pokes at is the layer just outside the plant fence: how the yard arbitrates dock doors when a SPAM line, a Jennie-O reefer, and a Planters-network shelf-stable lane all want the same gate window, and how T&M production capacity lift starts showing up first as queue at the gatehouse before anywhere else.",
      openingHook:
        "T&M is pulling production capacity through the plant. The first place that production capacity exceeds the existing yard reflex is the dock, and a multi-temp plant arbitrating three product profiles at the same gate doesn't have the same SOP slack a single-profile plant has.",
      stakeStatement:
      ...
      heroOverride: {
        headline: 'The Hormel Production System ends at the plant fence. The yard is the layer just outside it that has to keep up with T&M production capacity.',
        subheadline:
          'Multi-temp plants arbitrate SPAM, Jennie-O, and Planters at the same gate. As T&M production capacity compounds, the gate is where the first sign of the lift exceeding the existing reflex shows up.',
      },
      sectionOrder: ['yns-thesis', 'observation', 'artifact', 'comparable', 'methodology', 'about'],
