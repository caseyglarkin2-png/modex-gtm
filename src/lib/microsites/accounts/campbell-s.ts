 ...
 *         },
 *         {
 *           headline: 'Network Consolidation = More Production capacity Pressure',
...
export const campbellS: AccountMicrositeData = {
  ...
  signals: {
    ...
    supplyChainInitiatives: [
      ...
      'Maxton +$150M and Hanover +$72M expansions concentrating production capacity at the soup and snacks sites',
    ],
    urgencyDriver:
