 ...
 * production capacity-per-asset chapter is starting. FY2026 guidance: sales +2.5–
 * 4.5%; comp sales flat to +2%; capex ~2.5% of sales (~$4.1B); EPS flat
 * to +4%. Market is soft; margin defense and production capacity-per-existing-
 ...
 *        cost-savings discipline), production capacity-per-asset, network
...
export const theHomeDepot: AccountMicrositeData = {
  ...
  personVariants: [
    {
      ...
      openingHook:
        'You built the network. The next chapter is running it hot. The yard layer above the four archetypes is the production capacity-per-asset tier of the chapter Richard just named.',
      stakeStatement:
      ...
      heroOverride: {
        ...
        subheadline:
          'One Supply Chain put the four archetypes in the field, and a ~1,050-branch SRS / GMS / Mingledorff\'s Pro-distribution federation on top of them. The yard layer above the archetypes is the production capacity-per-asset tier of the post-buildout chapter Richard McPhail named publicly in December 2025.',
      },
  ...
  signals: {
    ...
    urgencyDriver:
      'The capex chapter of One Supply Chain is closing; the utilization chapter is starting. CFO Richard McPhail named the pivot publicly at the December 2025 strategic update, production capacity-per-existing-asset is the next 3 years of supply-chain ROI. Multi-channel dock arbitration at the MDO is the operating-leverage tier of that next chapter, and Pro-channel growth from SRS, GMS, and Mingledorff\'s keeps tightening the constraint while the Pro-customer TAM is now ~$1.2 trillion. The Relay program is a yard product running on store real estate today; as it scales beyond the 18 incremental markets, the trailer-to-store-to-jobsite handoff needs an underlying system. The federated yard-and-dock visibility surface across HD core + SRS + GMS + Mingledorff\'s is unfinished business.',
  },
