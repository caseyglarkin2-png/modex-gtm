    ...
    },
    {
      ...
      sources: [
        ...
        },
        {
          ...
          confidence: 'public',
          detail: 'AB InBev doubled its U.S. manufacturing investment to $600M for 2025–2026, including named site-level commitments at Cartersville GA ($9.2M), Houston TX ($17M), Jacksonville FL ($30M), and Los Angeles CA ($7.4M). Operationally, this is plant-level production capacity, packaging, and reliability capex, the kind that creates trailer pressure on the yard immediately downstream.',
        ...
        },
        {
          ...
          confidence: 'public',
          detail: 'Cross-industry baselines on dock-radio prevalence, dwell-time variance, and detention-cost ranges. These describe the conditions most multi-site beverage networks operate under at average production capacity, not AB InBev specifically.',
        },
        {
          id: 'primo-q1-2025',
      ...
      unknowns: [
        ...
        'Whether the dock-door logic at the Brewing Futures capex sites (Cartersville, Houston, Jacksonville, LA) has been re-spec\'d ahead of the production capacity lift, or whether the yard layer at those sites is operating against pre-capex baselines',
  ...
  roiModel: {
    ...
    accountAssumptions: [
      ...
      },
      {
        ...
        value: 5380,
        unit: 'moves/day',
        sourceNoteId: 'abi-production capacity-profile',
      },
      {
        label: 'Archetype mix',
    ...
    sourceNotes: [
      ...
      {
        id: 'abi-production capacity-profile',
        label: 'North America brewery production capacity profile',
