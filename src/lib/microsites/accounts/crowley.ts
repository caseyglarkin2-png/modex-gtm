 ...
 * terminal, ship-to-shore gantry discharge production capacity, and multi-modal
 ...
 * of Jan 1, 2026), operating discipline, production capacity-out-the-gantry,
...
export const crowley: AccountMicrositeData = {
  ...
  sections: [
    ...
    },
    {
      ...
      unknowns: [
        'How the Isla Grande terminal yard surface is currently performing against the Commitment Class production capacity baseline, three new ship-to-shore gantry cranes raised the discharge cadence, and whether the yard behind the gantry has matched the new production capacity is the discovery question that sizes the deployment',
  ...
  personVariants: [
    {
      ...
      openingHook:
        'The Commitment Class moved production capacity-out-the-gantry. The yard behind the gantry was not re-engineered at the same cadence. And as of January 6, 2026, the division that consolidates both sides of that handoff is yours.',
      stakeStatement:
        'The yard between the gantry and the gate is the layer the January 2026 division realignment, the Commitment Class economics, and the family-ownership capex horizon all converge on. Three windows that are not always open together; for the next twelve months they are.',
  ...
  freight: {
    ...
    specialRequirements: [
      'Port-terminal yard execution at modernized gantry-crane production capacity (Isla Grande post-Commitment-Class baseline)',
  ...
  signals: {
    ...
    urgencyDriver:
      'The January 6, 2026 division realignment is the first time in a decade the maritime and land businesses sit under one operating leader, James C. Fowler as EVP and Division President, Shipping & Logistics. The cheapest moment for a yard-execution operating-standard layer to enter the consolidated standard is during the consolidation window, not after. The Commitment Class ConRo program moved production capacity-out-the-gantry at Isla Grande to a baseline the yard behind the gantry was not re-engineered against; the Avance Class LNG-containership expansion did the same on the Central American and Caribbean calls. Underneath all three is the family-ownership long-horizon capex posture that underwrites multi-decade operating-model investment in a way no public-co peer can match.',
  },
  ...
  audioBrief: {
    src: '/audio/crowley.m4a',
    intro:
      "Eighteen minutes, dictated for the commute or the office walk. The same memo above, in audio, the yard between the gantry and the gate, at Isla Grande post-Commitment-Class, at the Jacksonville HQ campus post-realignment, and across the Caribbean and Central American calls. Skip into any chapter below; the page won't move.",
    chapters: [
      { id: 'seam', label: 'The seam under one operating leader', start: 0 },
      { id: 'gantry-gate', label: 'Where the gantry meets the gate', start: 220 },
      { id: 'primo-read', label: 'The Primo read-across, on harder freight', start: 440 },
