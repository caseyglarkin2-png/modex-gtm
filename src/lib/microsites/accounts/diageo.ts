 ...
 *           description: 'Holiday season drives 3x production capacity at Diageo distribution centers. The yard processes that work at baseline volume collapse under peak load. Gate queues back up, spotters are dispatched by phone calls, and dock turns drop below target.',
 *           kpiImpact: '15-20% production capacity loss during peak season from yard bottleneck',
 *           relevantPeople: ['diageo-mcintosh-hamilton', 'diageo-reddrick'],
 *         },
 *         {
 ...
 *       narrative: 'A trailer of Johnnie Walker or Don Julio can hold $500K+ in product. When that trailer sits in a yard queue with no priority flagging or dock assignment logic, you are parking half a million dollars in the dark. Meanwhile, holiday season drives 3x production capacity at Diageo distribution centers. The yard processes that work at baseline volume collapse under peak load. Gate queues back up, spotters are dispatched by phone calls, and dock turns drop below target.',
 ...
 *       narrative: 'YardFlow replaces the patchwork of local yard practices with a single standardized operating protocol. Same driver journey at every facility. same dock assignment logic. Variance dies. Production capacity becomes calculable.',
 *       modules: [
...
export const diageo: AccountMicrositeData = {
  ...
  sections: [
    { type: 'yns-thesis' },
    {
      ...
      composition: [
        ...
        { label: 'Peak pattern', value: 'Holiday-season production capacity surge (Q4) compresses dock and yard capacity sharply' },
    ...
    },
    {
      ...
      unknowns: [
        ...
        'Whether yard-layer cost and production capacity variance is currently captured inside the Accelerate $625M scorecard, or absorbed into per-site overhead lines that never roll up to the program tracker',
  ...
  signals: {
    ...
    urgencyDriver: 'Multi-site execution standardization is the stated priority. Holiday Q4 production capacity pressure is the timing driver.',
  },
