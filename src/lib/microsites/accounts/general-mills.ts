 ...
 *         { id: 'flowVISION', name: 'flowVISION', verb: 'Map', shortDescription: 'Digital twin of the yard. Real-time trailer location, dwell, and lane state.', relevanceToAccount: 'Complements General Mills\' Palantir digital twin - extends supply chain visibility to the yard surface.' },
      ...
      addSections: [
        ...
        },
        {
          ...
          modules: [
            ...
            { id: 'flowVISION', name: 'flowVISION', verb: 'Map', shortDescription: 'Real-time digital twin with spotter move queues built in. Temperature-zone aware. No radio.' },
