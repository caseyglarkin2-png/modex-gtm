 ...
 * Quality Tier: Tier 3 / Band D (reach account; pitch-shape adjusted to the
 * actual U.S. footprint per punch-list — five-facility frame, with HMGMA
 * Metaplant Bryan County GA as the marquee EV-era greenfield and the
 * highest-leverage pilot site for yard-operating-layer standardization)
 * Pitch shape: greenfield-anchored network operating model. HMGMA opened
 * with first IONIQ 5 production in October 2024 and grand opening in March
 * 2025 — the cleanest yard-ops-design window in the Hyundai Motor Group
 * U.S. portfolio. The four sites around it (HMMA Montgomery, the HL-GA
 * Battery Co JV, the Hyundai Mobis EV-power-electronics plant in Richmond
 * Hill, and Kia Georgia in West Point) are where the operating layer
 * laddered up from the greenfield then has to land.
 * Angle: YARD MANAGEMENT — JIT inbound to the assembly dock plus the
 * battery-cell flow from HL-GA into HMGMA plus the Mobis sub-assembly
 * cadence into both Georgia assembly plants. Five facilities, four cargo
 * profiles (vehicle parts, battery cells, sub-assemblies, finished-vehicle
 * outbound via Brunswick/Savannah), one un-standardized yard layer.
 */
...
export const hyundaiMotorAmerica: AccountMicrositeData = {
  ...
  pageTitle: 'Hyundai Motor America · HMGMA is the cleanest yard-ops greenfield in the U.S. portfolio',
  metaDescription:
    'Hyundai Motor Group runs a five-facility U.S. manufacturing cluster — HMMA Montgomery, HMGMA Metaplant in Bryan County GA, the HL-GA battery JV, the Hyundai Mobis EV power-electronics plant, and Kia Georgia in West Point. HMGMA opened production in October 2024 as the cleanest yard-ops greenfield in the network. The operating layer above the sites is unsolved.',
  ...
  sections: [
      ...
      composition: [
        {
          ...
          value:
            'Five-facility cluster — HMMA (Montgomery AL, opened 2005, ~358K vehicles in 2025, ~390K capacity; Santa Fe, Santa Fe Hybrid, Tucson, Santa Cruz, Genesis GV70 incl. Electrified GV70 on one flexible line); HMGMA Metaplant America (Ellabell, Bryan County GA — $7.6B, 500K vehicles/yr at full ramp, first 2025 IONIQ 5 off the line Oct 2024, grand opening March 2025; 2026 IONIQ 9 added; hybrid-capable); HL-GA Battery Company JV with LG Energy Solution co-located at the Metaplant ($4.3B); Hyundai Mobis EV Power Electric system plant (Richmond Hill GA — $926M, 1.2M sq ft, supplies up to 900K EV power-electric systems + 450K integrated charging control units annually to HMGMA, HMMA, and Kia Georgia); Kia Georgia (West Point — 350K/yr capacity; Telluride, Sorento, Sportage, plus EV6 and EV9 both in full production in 2025)',
        },
        {
          label: 'Marquee greenfield in the network',
          value:
            'HMGMA Metaplant is the highest-leverage single yard-ops design window in the U.S. portfolio. Vertically integrated with the HL-GA battery JV next door, supplied with EV power electronics from Mobis Richmond Hill, and feeding finished-vehicle outbound through Glovis America at Colonel\'s Island (Brunswick) and the Savannah consolidation center (~69,000 sq m). The operating pattern at HMGMA is being set now in the production-ramp window',
        },
        {
          label: 'Inbound cargo profile mix',
          value:
            'Four structurally different freight types into the cluster simultaneously: traditional JIT parts (HMMA Montgomery, twenty years of established discipline); battery-cell inbound (HL-GA → HMGMA, heavy, regulated, single-source, greenfield staging); EV power-electronics sub-assemblies (Mobis Richmond Hill → HMGMA + HMMA + Kia Georgia, three-destination consolidation cadence); finished-vehicle outbound (HMGMA + HMMA + Kia Georgia → Brunswick / Savannah via Glovis). Same dock infrastructure absorbs all of it where the lanes converge',
        },
        {
          label: 'Logistics-arm involvement',
          value:
            'Hyundai Glovis America coordinates a meaningful share of the inbound parts logistics and substantially all of the finished-vehicle outbound through Brunswick and Savannah. The lane-planning-to-receiving-yard handoff between Glovis and each assembly plant is one of the seams the operating model runs through — and the Glovis EV Logistics America Savannah consolidation center (recently established, ~69,000 sq m) is the structural anchor of the EV-era outbound flow',
        },
        {
          label: 'EV ramp + executive context',
          value:
            'José Muñoz became Hyundai Motor Company\'s first non-Korean global President & CEO on January 1, 2025, with the HMGMA Metaplant ramp and the Georgia battery JVs (HL-GA at the Metaplant, plus the SK On battery JV in Bartow County coming online to support 300K all-electric vehicles annually across Hyundai, Kia, and Genesis) as the highest-visibility investments inside his portfolio. The Group has publicly committed to expanding U.S. production capacity to 1.2M vehicles annually across the three brands',
        },
        {
    ...
    },
    {
      ...
      timeline:
        "30–60 days from kickoff to first measurable impact at the pilot site. The highest-leverage pilot in the Hyundai Motor America cluster is HMGMA Metaplant — and the reason is structural, not preferential. Greenfield yard-ops design at a $7.6B plant ramping toward 500,000 vehicles annually means no entrenched local routine to displace, the operating pattern is still inside the design window in the first three to four quarters after first production (Oct 2024), and every other node in the cluster — HMMA, Kia Georgia, Mobis Richmond Hill, the Glovis-coordinated outbound flow — has a structural reason to inherit a protocol that lands at the Metaplant first. The secondary pilot is HMMA Montgomery, because that's where any network-wide protocol ultimately has to prove out against twenty years of established site-level routine on the same flexible assembly line that builds five vehicle programs in mixed sequence. We would expect the network operating model to make sense of itself across the cluster within two to four quarters of the Metaplant pilot.",
    ...
    },
    {
      ...
      sources: [
        ...
        },
        {
          ...
          source: 'José Muñoz CEO appointment record',
          confidence: 'public',
          detail: 'Muñoz became Hyundai Motor Company\'s first non-Korean global President & CEO effective January 1, 2025, after joining Hyundai in 2019 as Global COO and President/CEO of Hyundai and Genesis Motor North America. The HMGMA Metaplant ramp and the Georgia battery JVs are the highest-visibility investments inside his portfolio, with public commitments to expand U.S. production capacity to 1.2M vehicles annually across Hyundai, Kia, and Genesis.',
      ...
      unknowns: [
        ...
        'How the Glovis America inbound and outbound flows interact with each plant\'s yard layer today, and where the carrier-scheduling-to-dock-execution handoff actually lives',
        ...
        'Which executive function inside Hyundai Motor America owns the cross-plant yard-operating-model decision today — and whether the seat exists or needs to be created',
      ],
    },
    {
      type: 'about',
      ...
      signOff:
        "If parts of this read wrong against what you see internally for Hyundai Motor America — particularly whether the HMGMA yard-ops design window is still open, how the HL-GA battery-cell inbound is staged at the Metaplant dock today, how the Mobis Richmond Hill three-destination cadence interacts with three receiving-yard histories, or how the Glovis outbound through Brunswick and Savannah currently lands at each plant's finished-vehicle yard — that's the most useful thing to push back on. The next step that makes sense is whatever the analysis prompts, not necessarily a meeting.",
    },
  ],
  ...
  personVariants: [
    {
      ...
      framingNarrative:
        "Carey, the analytical wedge on the Hyundai Motor America cluster is timing-shaped. HMGMA is inside the three-to-four-quarter window after first production (Oct 2024) where the yard-ops operating pattern is still being set rather than defended — and the rest of the five-facility cluster has a structural reason to inherit whatever protocol lands at the Metaplant. Twenty years of HMMA Montgomery shows what gets built when the in-plant JIT work is standardized and the yard layer outside the gate is left to its own history.",
      openingHook:
  ...
  signals: {
    ...
    recentNews: [
      ...
      'Hyundai Glovis America operates a Brunswick GA facility at Colonel\'s Island Terminal and recently established a ~69,000 sq m consolidation center in Savannah.',
