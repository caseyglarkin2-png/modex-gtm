...
export const canonicalNavModules: NavModule[] = [
  { id: 'home', label: 'Home', href: '/', icon: Home, aliases: ['/'] },
  { id: 'accounts', label: 'Accounts', href: '/accounts', icon: Building2, aliases: ['/accounts'] },
  { id: 'contacts', label: 'Contacts', href: '/contacts', icon: Users, aliases: ['/contacts', '/personas'] },
  { id: 'campaigns', label: 'Campaigns', href: '/campaigns', icon: Megaphone, aliases: ['/campaigns', '/waves', '/waves/campaign'] },
  ...
  { id: 'content-studio', label: 'Content Studio', href: '/studio', icon: FileText, aliases: ['/studio', '/generated-content', '/briefs', '/search', '/intel', '/audit-routes', '/qr', '/for', '/proposal'] },
  { id: 'pipeline', label: 'Pipeline', href: '/pipeline', icon: GitBranch, aliases: ['/pipeline', '/activities', '/meetings'] },
...
export const commandRoutes: CommandRoute[] = [
  ...
  { label: 'Personas', href: '/personas', icon: Users, keywords: ['Personas', 'People'], canonicalOwner: 'Contacts' },
  { label: 'Outreach Waves', href: '/waves', icon: Megaphone, keywords: ['Outreach Waves', 'Waves'], canonicalOwner: 'Campaigns' },
  { label: 'Campaign HQ', href: '/waves/campaign', icon: Megaphone, keywords: ['Campaign HQ', 'MODEX HQ'], canonicalOwner: 'Campaigns' },
  ...
  { label: 'Generated Content', href: '/generated-content', icon: FileText, keywords: ['Generated Content', 'One-Pagers'], canonicalOwner: 'Content Studio' },
  { label: 'Meeting Briefs', href: '/briefs', icon: FileText, keywords: ['Meeting Briefs', 'Briefs'], canonicalOwner: 'Content Studio' },
  { label: 'Search Strings', href: '/search', icon: Search, keywords: ['Search Strings'], canonicalOwner: 'Content Studio' },
  { label: 'Actionable Intel', href: '/intel', icon: HeartPulse, keywords: ['Actionable Intel', 'Intel'], canonicalOwner: 'Content Studio' },
  { label: 'Audit Routes', href: '/audit-routes', icon: FileText, keywords: ['Audit Routes'], canonicalOwner: 'Content Studio' },
  { label: 'QR Assets', href: '/qr', icon: FileText, keywords: ['QR Assets', 'QR'], canonicalOwner: 'Content Studio' },
