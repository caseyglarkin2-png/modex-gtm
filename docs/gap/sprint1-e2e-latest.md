...
- Run tag: gap-e2e-1790186307723
- Database: 127.0.0.1:5433/gap_dev (scratch only; the script refuses any other host)
- Git: cedcfc4f
- Ran at: 2026-09-23T17:58:27.955Z
- HUBSPOT_SYNC_ENABLED as resolved by feature-flags: false
...
- PASS 1 seed: account, personas 3 (ready) and 4 (suppressed), 2 triggers
- PASS 2 hypothesize: signals.created=2 proposed=2 draft=cmueepfjo00057kto1wqls6e4 family=hidden_capacity signals=1 suppressed_hits=0
...
- PASS 5 negative: needsObservation=true, submit refused no_signals, duplicate_source_ref existingId=cmueepfll000m7ktokepielx7
