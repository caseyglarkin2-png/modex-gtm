...
- PASS 1 seed: account, personas 16 (ready, director), 17 (ready, vp), 18 (suppressed), 2 triggers 10 days old, fixture accounts Dell + J.B. Hunt, sequence 4 with 2 draft queue rows (approved + draft) on run gap-e2e2-1790199179979-run
- PASS 2 hypothesize: signals.created=2 proposed=3 opsDraft=cmuemdbv100097kcclhb11jo2 (yard_state_integrity) execDraft=cmuemdbv7000d7kccy45fnhrd (hidden_capacity); fact cmuemdbvg000h7kccoeouyx8l linked (1 -> 2), relink already, unlink of cited cmuemdbuj00037kccg07k78yk refused signal_cited; 3 drafts submitted and approved
- PASS 3 sync: families created 2 (311519882, 311861043), enrollments created 1 (faa7de58-3492-5297-9367-61d303ed3698, legacy, version still draft per R2-5), rosters missing ["jbhunt-com"], reported {"other_sequence":0,"not_enrolled":6,"no_email":0,"no_contact_id":0}; second run created 0 / existing 2 / unchanged 1; 2 readback calls
- PASS 4 replies: first poll created 1 filtered {auto_reply_subject: 1}, inbound hs:gap-e2e2-1790199179979-e1 on hs-thread:gap-e2e2-1790199179979-c1, notifications reply + filtered_inbound; second poll created 0 existing 2; watermark advanced; 2 fixture searches
- PASS 5 routing: run A mode shadow: 2 decisions {"enroll":1,"suppressed":1}, skips {"in_flight":1}; exec persona 17 -> enroll (target modex_queue, hypothesis cmuemdbv7000d7kccy45fnhrd); do_not_contact persona -> suppressed / do_not_contact / blocked (R2-1); every row carries account + persona; queue ordered by priority; human action ok then already_acted, missing id not_found
- PASS 6 enroll rows: header + 1 row for GAP E2E Co gap-e2e2-1790199179979: sequence NOT BUILT, 0 contacts, 1 skip (E2E Exec gap-e2e2-1790199179979: modex_queue (no native sequence; secondary lane))
...
- PASS 8 stop: cancelDownstream(replied) marked 2 rows skipped with sequence_stopped:replied, 2 rows remain, rerun marks 0; routing run B: {"enroll":1,"suppressed":1,"reply_pending":1}, ready persona 16 -> reply_pending (rule id printed as observed)
